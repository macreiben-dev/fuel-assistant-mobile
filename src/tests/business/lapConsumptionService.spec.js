...
describe("Fuel tank content", () => {
  test('Given fuel tank content is "hello" then do not update store.', () => {
    ...
    // ACT
    lapFuelTankContentService("hello", originalProps, undefined, validator);
  ...
  // ACT
  lapFuelTankContentService(12, originalProps, converter, validator);
